...
// lifecycle, and the publishing vendor (AttributePublisher) for each
// offering, plus the derivations a discovery surface needs (current vs
// previous generation, replacement, retirement, price tier).
//
// # Shape
//
