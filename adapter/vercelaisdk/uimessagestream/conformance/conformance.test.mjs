...
//
// The server side is AgentHandler over an llmagent running against scripted
// fake models — the full agent loop, not a bare protocol shim. Agent tools are
// runtime-discovered, so the client assembles them as dynamic-tool parts.
