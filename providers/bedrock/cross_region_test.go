...
func TestIsModelAllowedFromRegion(t *testing.T) {
	...
	tests := []struct {
		...
		{"gpt-6-astra us from ca-central-1", ModelGPT6AstraUS, "ca-central-1", true},
		{"gpt-6-astra us from eu-west-1", ModelGPT6AstraUS, "eu-west-1", false},
		{"gpt-6-astra global from eu-west-1", ModelGPT6AstraGlobal, "eu-west-1", true},
		...
		{"opus5.5 au from ap-southeast-2", ModelClaudeOpus55AU, "ap-southeast-2", true},
		{"opus5.5 eu from eu-west-1", ModelClaudeOpus55EU, "eu-west-1", true},
		{"opus5.5 us from us-east-1", ModelClaudeOpus55US, "us-east-1", true},
		{"opus5.5 global from ap-northeast-1", ModelClaudeOpus55Global, "ap-northeast-1", true},
